...
export const metadata: Metadata = {
  ...
  description: "A simple blog website providing step-by-step guides and tips for troubleshooting and resolving the most frequent errors on personal computers.",
};
